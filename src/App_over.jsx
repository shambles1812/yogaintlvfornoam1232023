...
export default function App_over() {
  ...
  if(mobileView == true){
    ...
    { 
      ...
      <div className="w-full h-[75%] pt-[35%]">
        <img src={homepage}  className=" object-cover bg-center h-full"/>
        
      </div>
      
      <div id="entry_button" className=" text-center h-auto">
        <div className=" text-[20px] my-[2%] py-[15px] h-[60px] bg-sky-blue w-5/6 mx-auto rounded-[40px] align-middle " onClick={()=>setfirstVisit(true)}>
        <>{console.log(firstVisit)}</>
        דואמ הבוט ימ? 
        </div>
      </div>
